...
$experience = [
    [
        ...
        'date' => 'Jan 2015 - ',
        'end_date' => 'Current',
        'description' => 'Cliens valde contentus est. Non loqui de thema politica',
    ],
    [
        ...
        <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-suitcase fa-fw w3-margin-right w3-xxlarge w3-text-teal"></i>Опыт работы</h2>
            <?php for ($i = 0; $i < count($experience); $i++): ?>
                <div class="w3-container">      
                    ...
                    <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"><?php echo $experience[$i]["date"] ?></i>
                    <span class="w3-tag w3-teal w3-round"><?php if ($experience[$i]["end_date"] == "Current") echo " Current" ?></span></h6>
